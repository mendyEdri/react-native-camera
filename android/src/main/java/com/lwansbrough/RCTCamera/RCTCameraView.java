...
public class RCTCameraView extends ViewGroup {
    ...
    public void setCaptureMode(final int type) {
        this._viewFinder.setCameraMediaTypeVideo(type == 1 ? true : false);
    }
    ...
    public void setCameraType(final int type) {
        if (null != this._viewFinder) {
            ...
            RCTCamera.getInstance().setViewFinderInstance(_viewFinder);
